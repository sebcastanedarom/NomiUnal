...
export default class PagoContratista implements TipoPago{
    async appyPago(identificacion: bigint): Promise<any> {
        ...
        console.log(salario,valorIncapacidad,eps,afp, valorHoras, PercepTotal )
        const salarioF = salario-valorIncapacidad+ valorHoras+ PercepTotal;
